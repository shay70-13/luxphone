    ...
    <div className="page">
      <div className="contact-wrap">
        ...
        <div className="contact-info">
          ...
          <h1 className="page-title">Parlons <em>Ensemble</em></h1>
        ...
        <div className="contact-form">
          {sent ? (
            <div className="form-success anim-popin">
              ...
              <p>Merci <strong style={{ color: "var(--text)" }}>{form.nom}</strong>,
                nous vous répondrons très prochainement.</p>
            </div>
          ) : (
            <>
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input name="nom" value={form.nom} onChange={handleChange}
                    placeholder="Léa Obiang" className={errors.nom ? "error" : ""} />
                  {errors.nom && <span className="error-msg">{errors.nom}</span>}
                </div>
                <div className="form-group">
                  <label>Email *</label>
                  <input name="email" type="email" value={form.email} onChange={handleChange}
                    placeholder="lea@email.ga" className={errors.email ? "error" : ""} />
              ...
              <button className="btn btn-solid btn-full" onClick={handleSubmit} disabled={loading}>
                {loading ? (
